...
class MGame():
    ...
    def draw(self):
        ...
        # fonts
        title_font = pygame.font.Font('memory_game/fonts/Little Alien.ttf', 44)
        content_font = pygame.font.Font('memory_game/fonts/Little Alien.ttf', 24)
        ...
        pygame.draw.rect(screen, WHITE, (screen_width - 90, 0, 100, 50))
