...
class Game(object):
    def __init__(self):
        ...
        self.score_font = pygame.font.Font("math_game/kenvector_future.ttf", 20)
        ...
        self.background_image = pygame.image.load("math_game/background.webp").convert()
        # load sounds effects
    ...
    def get_symbols(self):
        ...
        symbols = {}
        sprite_sheet = pygame.image.load("math_game/symbols.png").convert()
