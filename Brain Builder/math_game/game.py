...
import pygame
import random
from math_game.menu import Menu
...
class Game(object):
    def __init__(self):
        # Timer variables
        self.timer_duration = 30  # 30 seconds
        self.start_time = None
        # Create a new font obeject
        self.font = pygame.font.Font(None, 65)
        # Create font for the score msg
        
        self.score_font = pygame.font.Font("math_game/Roboto-Medium.ttf", 36)
        ...
        self.menu = Menu(
            items, ttf_font="math_game/XpressiveBlack Regular.ttf", font_size=50)
        # True: show menu
        self.show_menu = True
        ...
        self.background_image = pygame.image.load("math_game/background.jpg")
        # load sounds effects
        self.sound_1 = pygame.mixer.Sound("math_game/item1.ogg")
        self.sound_2 = pygame.mixer.Sound("math_game/item2.ogg")
    ...
    def get_button_list(self):
        ...
        if choice == 1:
            ...
            btn = Button(posX, posY, width, height, random.randint(0, 150))
            button_list.append(btn)
    ...
    def get_symbols(self):
        ...
        symbols = {}
        sprite_sheet = pygame.image.load("math_game/symbols.png")
    ...
    def run_logic(self):
        ...
        if self.start_time is not None:
            ...
            if elapsed_time >= self.timer_duration:
                # Timer has expired, reset the problem
                self.set_problem()
                self.count += 1
    ...
    def display_frame(self, screen):
        ...
        if self.show_menu:
            ...
            # and the score
            msg_1 = "You answered " + str(int(self.score / 5)) + " correctly"
            ...
            posX = (SCREEN_WIDTH / 2) - (t_w / 2)
            screen.blit(label_1, (posX, 250))
            # print the symbol into the screen
            screen.blit(self.symbols[self.operation],
                        (posX + label_1.get_width(), 240))

            screen.blit(label_2, (posX + label_1.get_width() + 64, 250))
            ...
            timer_label = self.score_font.render(f"Time: {remaining_time} s", True, BLACK)
            screen.blit(timer_label, (SCREEN_WIDTH - 150, 10))
